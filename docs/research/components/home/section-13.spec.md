...
page: /
screenshot: docs/design-references/gulabojaipur.com/section-13-pc.png
...
- article.card [286×492]
  ...
  - div.card-info [286×88]
    - p.card-cat — "Dresses"
    - h3.card-title > a — "Dill Red Dress"
    - p.card-price
      - span.now — "₹3,150.00"
      - span.was — "₹4,500.00"
...
- **h3.card-title > a ("Dill Red Dress")** [107×22]: 18.88px/500/22.2784px rgb(42, 32, 27); center
- **div.card-info > p.card-price** [282×20]: flex row gap 9px justify center items baseline
- **p.card-price > span.now ("₹3,150.00")** [70×20]: 14.4px/400/- 0.576px rgb(42, 32, 27); center
- **p.card-price > span.was ("₹4,500.00")** [63×19]: 12.8px/300/- 0.576px rgb(128, 112, 100); center
...
## Assets
- img IMG_7308.jpg (640×960) alt "Dill Red Dress" → NOT DOWNLOADED — check assets.json
- img IMG_7318.jpg (640×960) alt "Dill Red Dress" → NOT DOWNLOADED — check assets.json
...
## Responsive Behavior
<!-- AGENT: fill — no responsive.json entry for "section-13" — run probe.mjs --route / and fill measured values for phone/ipad/pc -->
