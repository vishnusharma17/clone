...
page: /
screenshot: docs/design-references/gulabojaipur.com/section-12-pc.png
...
- article.card [286×492]
  ...
  - div.card-info [286×88]
    - p.card-cat — "Dresses"
    - h3.card-title > a — "Nayn Aqua Dress"
    - p.card-price
      - span.now — "₹4,200.00"
      - span.was — "₹6,000.00"
...
- **h3.card-title > a ("Nayn Aqua Dress")** [128×22]: 18.88px/500/22.2784px rgb(42, 32, 27); center
...
## Assets
- img Nayn-Aqua-Dress-Gulabo-Jaipur-4061.jpg (640×960) alt "Nayn Aqua Dress" → NOT DOWNLOADED — check assets.json
...
## Responsive Behavior
<!-- AGENT: fill — no responsive.json entry for "section-12" — run probe.mjs --route / and fill measured values for phone/ipad/pc -->
