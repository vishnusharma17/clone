---
component: Section11Section
target: src/components/Section11Section.tsx
page: /
screenshot: docs/design-references/gulabojaipur.com/section-11-pc.png
...
# Section11Section Specification
...
- article.card [286×492]
  ...
  - div.card-info [286×88]
    - p.card-cat — "Dresses"
    - h3.card-title > a — "Nayn Green Dress"
    - p.card-price
      - span.now — "₹4,200.00"
      - span.was — "₹6,000.00"
...
- **h3.card-title > a ("Nayn Green Dress")** [134×22]: 18.88px/500/22.2784px rgb(42, 32, 27); center
- **div.card-info > p.card-price** [282×20]: flex row gap 9px justify center items baseline
- **p.card-price > span.now ("₹4,200.00")** [73×20]: 14.4px/400/- 0.576px rgb(42, 32, 27); center
- **p.card-price > span.was ("₹6,000.00")** [63×19]: 12.8px/300/- 0.576px rgb(128, 112, 100); center
...
## Assets
- img Nayn-Green-Dress-Gulabo-Jaipur-3366.jpg (640×960) alt "Nayn Green Dress" → NOT DOWNLOADED — check assets.json
...
## Responsive Behavior
<!-- AGENT: fill — no responsive.json entry for "section-11" — run probe.mjs --route / and fill measured values for phone/ipad/pc -->
