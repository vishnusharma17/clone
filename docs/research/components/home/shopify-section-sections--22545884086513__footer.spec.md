---
component: ShopifySectionSections22545884086513FooterSection
target: src/components/ShopifySectionSections22545884086513FooterSection.tsx
page: /
screenshot: docs/design-references/gulabojaipur.com/shopify-section-sections--22545884086513__footer-pc.png
...
# ShopifySectionSections22545884086513FooterSection Specification

## DOM Structure
- div.shopify-section.shopify-section-group-footer-group > footer > div.wrap [1360×467]
...
## Computed Styles
- **div.shopify-section.shopify-section-group-footer-group > footer** [1440×589]: bg rgb(42, 32, 27); pad 92px 0px 30px 0px
...
- exact per-property values: probe-shopify-section-sections-22545884086513-footer.json + responsive.json (ground truth)
