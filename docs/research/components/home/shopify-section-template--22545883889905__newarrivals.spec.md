---
component: ShopifySectionTemplate22545883889905NewarrivalsSection
target: src/components/ShopifySectionTemplate22545883889905NewarrivalsSection.tsx
page: /
screenshot: docs/design-references/gulabojaipur.com/shopify-section-template--22545883889905__newarrivals-pc.png
...
# ShopifySectionTemplate22545883889905NewarrivalsSection Specification

## DOM Structure
- div.shopify-section > section.sec.wrap [1360×944]
  - div.sec-head [1360×87]
    - span.kicker — "Fresh Off the Block"
    - h2 — "New Arrivals"
  - div.rail-wrap [1360×519]
    ...
    - div.rail
      - ×10 article.card
        - a.card-media
        - div.card-info
  - div.rail-foot > a.btn.btn-ink [253×44] — "View All New Arrivals"

## Computed Styles
- **div.sec-head > span.kicker ("Fresh Off the Block")** [1360×16]: 11.52px/500/- 3.9168px rgb(174, 63, 88); center; uppercase; mb 14px
- **div.sec-head > h2 ("New Arrivals")** [1360×57]: 54.4px/400/57.12px rgb(42, 32, 27); center
...
- **div.rail-foot > a.btn.btn-ink ("View All New Arrivals")** [253×44]: 11.84px/500/- 2.6048px rgb(42, 32, 27); center; uppercase; border 1px solid rgb(42, 32, 27); pad 12.432px 27.232px 12.432px 27.232px; flex row gap 7.104px items center
...
## Text Content
- span: "Fresh Off the Block"
- h2: "New Arrivals"
- a: "View All New Arrivals"

## Responsive Behavior
<!-- AGENT: fill — no responsive.json entry for "shopify-section-template--22545883889905__newarrivals" — run probe.mjs --route / and fill measured values for phone/ipad/pc -->
