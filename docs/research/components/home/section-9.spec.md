...
page: /
screenshot: docs/design-references/gulabojaipur.com/section-9-pc.png
...
- article.card [286×470]
  ...
  - div.card-info [286×88]
    - p.card-cat — "Dresses"
    - h3.card-title > a — "Nayn Brown Dress"
    - p.card-price
      - span.now — "₹4,200.00"
      - span.was — "₹6,000.00"
...
- **h3.card-title > a ("Nayn Brown Dress")** [138×22]: 18.88px/500/22.2784px rgb(42, 32, 27); center
...
## Assets
- img Nayn-Brown-Dress-Gulabo-Jaipur-7917.jpg (640×960) alt "Nayn Brown Dress" → NOT DOWNLOADED — check assets.json
- img Nayn-Brown-Dress-Gulabo-Jaipur-3555.jpg (640×960) alt "Nayn Brown Dress" → NOT DOWNLOADED — check assets.json
...
## Responsive Behavior
<!-- AGENT: fill — no responsive.json entry for "section-9" — run probe.mjs --route / and fill measured values for phone/ipad/pc -->
